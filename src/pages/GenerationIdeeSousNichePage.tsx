...
type PageState = { input: string; result: string };
const defaults: PageState = { input: "", result: "" };
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="tool-card space-y-6">
        <div className="space-y-2">
          <label className="text-sm text-muted-foreground block">Décrivez votre niche</label>
          <Textarea
            value={input}
